<div class="table-wrapper">
	<table id="cases-table" class="table table-hover">
		<thead>
			<tr>
				<th>#</th>
				<th>Title</th>
    			...
    			<tr>
    				...
    				<td>
    					<small>
    						...
    						<a href="{{ url('/m/cases/delete/'.$element->id) }}" class="text-danger confirm-action">delete</a>
    					</small>
                    </td>
                </tr>
			@endforeach
    ...
    @foreach ($cases as $element)
        @include('partials.case-view', ['active_object' => $element])
