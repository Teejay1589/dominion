        ...
        <div class="container-fluid">
            <div class="row bg-white has-shadow">
                ...
                <div class="col-xl-3 col-sm-6">
                    ...
                    <div class="add-new">
                        <a class="btn btn-xs btn-small bg-violet">Add New Case</a>
                    </div>
                </div>
                <!-- Item -->
                <div class="col-xl-3 col-sm-6">
                    ...
                    <div class="add-new">
                        <a class="btn btn-xs btn-small bg-orange">Register New Patient</a>
                    </div>
                </div>
                <!-- Item -->
                <div class="col-xl-3 col-sm-6">
                ...
                <div class="row bg-white has-shadow">
                    <div class="left-col col-lg-6 d-flex align-items-center justify-content-between">
                        <div class="project-title d-flex align-items-center">
                            <div class="image has-shadow"><img src="img/default.png" alt="..."
                                                               class="img-fluid"></div>
                            <div class="text">
