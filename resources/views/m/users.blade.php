                        ...
                        <div class="panel mb5">
                            <div class="panel-heading p10 pb5" role="tab" id="panel-heading{{ $element->id }}">
                                ...
                                <h5 class="panel-title" title="table OR model involved">
                                    <a data-toggle="collapse" data-parent="#accordio" href="#collapse{{ $element->id }}" aria-expanded="true" aria-controls="collapse{{ $element->id }}" class="mr10">{{ str_ireplace('_', ' ', $element->full_name()) }} <small></small></a>
                                </h5>
                                <div class="mb5"></div>
                                <span>
