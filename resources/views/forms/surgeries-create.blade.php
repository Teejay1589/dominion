				...
				<div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-xs-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="date" name="started_at" placeholder="YYYY-MM-DD" value="{{ old('started_at') }}" required>
                            </div>
                        </div>
                        <div class="col-lg-6 col-xs-12">
                            <div class="form-group">
                                <label class="form-control-label">Ended At</label>
                                <input class="form-control" type="date" name="ended_at" placeholder="YYYY-MM-DD" value="{{ old('ended_at') }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
						<label class="form-control-label form-check form-check-inline">
							<input type="checkbox" name="is_success" class="form-check-input" value="1" {{ old('is_success') == 1 ? 'checked' : '' }}> Is Successful
						</label>
					</div>
				</div>
