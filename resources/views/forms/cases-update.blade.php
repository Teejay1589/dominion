				...
				<div class="modal-body">
					...
					<div class="form-group">
						<label class="form-control-label form-check form-check-inline">
							<input type="checkbox" name="is_consultation" class="form-check-input" value="1" {{ old('is_consultation', $active_object->is_consultation) == 1 ? 'checked' : '' }}> is a Consultation
						</label>
						<label class="form-control-label form-check form-check-inline">
							<input type="checkbox" name="is_emergency" class="form-check-input" value="1" {{ old('is_emergency', $active_object->is_emergency) == 1 ? 'checked' : '' }}> is an Emergency
						</label>
						<label class="form-control-label form-check form-check-inline">
							<input type="checkbox" name="is_delivery" class="form-check-input" value="1" {{ old('is_delivery', $active_object->is_delivery) == 1 ? 'checked' : '' }}> is a Delivery
						</label>
						<label class="form-control-label form-check form-check-inline">
